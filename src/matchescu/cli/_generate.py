...
@click.option("-c", "--cols", type=str, multiple=True)
def main(input_file: str, output_directory: str, gold_standard: str, cols: list[str]):
    generate(input_file, output_directory, gold_standard, cols)


def generate(
    input_file: str, output_directory: str, gold_standard: str, cols: list[str]
):
